...
exports.sendEmail = function(req, res) {
  ...
  var  htmlText = '<div style="background:#F2F2F2"> <div id="div1" style=" background:#000000; text-align:center; max-width: 70%; margin: auto;"> <img style=" margin-top: 50px; width: 12%; margin-left: 72%;" src="https://prismafest.herokuapp.com/images/puchaus-02.png"> <img src="https://prismafest.herokuapp.com/images/felicidades-01.png" style="width:60%;"> <h3 style=" margin: 0px; font-size: 130%; font-family: lato; font-weight: 500; color: white; letter-spacing: 5px;">SOS DE LOS QUE SE ATREVEN</h3> <img style=" width: 12%; margin-right: 72%; margin-bottom: 50px;" src="https://prismafest.herokuapp.com/images/puchaus-01.png"> </div> <div id="div2" style=" background:#FFFFFF; text-align:center; max-width: 70%; margin: auto;">  <div style="display:inline-flex;"><h2 style="margin: 0px; margin-left:45px; padding-top: 80px; margin-bottom: 40px; font-size: 25px; font-family: lato; font-weight: bold; color: black; letter-spacing: 5px;">¿ESTÁS LISTO?</h2><img style=" max-height: 25px; padding-top: 80px;" src="https://prismafest.herokuapp.com/images/puchaus-03.png"></div> <p style="  margin: auto; margin-bottom: 40px; font-size: 18px; font-family: lato; font-weight: 500; color: #424242; width: 90%;">A pesar del miedo y la incertidumbre sos de los que toman riesgos. Ahora tienes el primer paso a lo desconocido. Esta aventura está llena de sueños, retos, fracasos y obstáculos, pero al final todo valdrá la pena.</p> <div style="height:100px;"> <a style="cursor: pointer; text-decoration: none;" href="https://prismafest.herokuapp.com/images/PrimerPrisma.pdf" download><img style="height:50px;max-width:90%;" src="https://prismafest.herokuapp.com/images/puchaus-04.png"></a> </div> </div> <div id="div3" style=" background:#F2F2F2; text-align:center; max-width: 70%; margin: auto;"> <a style="text-decoration: none; margin-left: 98%;" href="https://www.facebook.com/prismafest.cr/" target="_blank"><img style=" max-height: 20px; margin-right: 10px; margin-top: 10px; cursor: pointer;" src="https://prismafest.herokuapp.com/images/puchaus-05.png"></a> <br> <img style=" max-height: 100px; margin-top: 40px; margin-bottom: 30px;" src="https://prismafest.herokuapp.com/images/puchaus-06.png"> <br> <div style="height:80px;"> <a style="text-decoration: none; color: #999999; cursor: pointer; font-family: lato; font-size: 20px;" href="https://prismafest.com/" target="_blank">www.prismafest.com</a> </div> </div> </div>',
    mailOptions = {
...
exports.contactInfo = (req, res) => {
    db.collection('info').insert(req.body, (error, doc) => {
        if(error) {throw error; res.send(400, {error:'Hemos tenido un error, favor enviar la información nuevamente'})}
        else{
            res.send(200,{info:'Message Sent'} ); 
            /*let htmlText = '<div style="background:#F2F2F2"> <div id="div1" style=" background:#000000; text-align:center; max-width: 70%; margin: auto;"> <img style=" margin-top: 50px; width: 12%; margin-left: 72%;" src="https://prismafest.herokuapp.com/images/puchaus-02.png"> <img src="https://prismafest.herokuapp.com/images/felicidades-01.png" style="width:60%;"> <h3 style=" margin: 0px; font-size: 130%; font-family: lato; font-weight: 500; color: white; letter-spacing: 5px;">SOS DE LOS QUE SE ATREVEN</h3> <img style=" width: 12%; margin-right: 72%; margin-bottom: 50px;" src="https://prismafest.herokuapp.com/images/puchaus-01.png"> </div> <div id="div2" style=" background:#FFFFFF; text-align:center; max-width: 70%; margin: auto;">  <div><h2 style="margin: 0px; padding-top: 80px; margin-bottom: 40px; font-size: 145%; font-family: lato; font-weight: bold; color: black; letter-spacing: 5px;">¡ESTÁS INVITADO!</h2></div> <p style="  margin: auto; margin-bottom: 40px; font-size: 18px; font-family: lato; font-weight: 500; color: #424242; width: 90%;">Bienvenido ' + req.body.name+'. Pronto le estaremos contactando para compartirle más información del evento.</p><p style="  margin: auto; padding-bottom: 40px; font-size: 18px; font-family: lato; font-weight: 500; color: #424242; width: 90%;">Igualmente puede hacernos sus consultas al correo <b>info@prismafest.com </b>. Nos vemos el día del evento.</p> </div> <div id="div3" style=" background:#F2F2F2; text-align:center; max-width: 70%; margin: auto;"> <a style="text-decoration: none; margin-left: 98%;" href="https://www.facebook.com/prismafest.cr/" target="_blank"><img style=" max-height: 20px; margin-right: 10px; margin-top: 10px; cursor: pointer;" src="https://prismafest.herokuapp.com/images/puchaus-05.png"></a> <br> <img style=" max-height: 100px; margin-bottom: 30px;" src="https://prismafest.herokuapp.com/images/puchaus-06.png"> <br> <div style="height:80px;"> <a style="text-decoration: none; color: #999999; cursor: pointer; font-family: lato; font-size: 20px;" href="https://prismafest.com/" target="_blank">www.prismafest.com</a> </div> </div> </div>',
            mailOptions = {
              from: '"Prisma Fest" <info@prismafest.com>',
              to: req.body.email, // receiver
              subject: 'Prisma Fest', // subject
                        ...
                        if(error3) {throw error3; res.send(400, {error:'Hemos tenido un error, favor solicitar la reserva nuevamente'})}
                            ...
                            db.collection('reservations').findAndModify({_id:req.body.conf},{},{$push:{signed:req.body.email}}, (error4, doc4) => {
                                if(error4) {throw error4; res.send(400, {error:'Hemos tenido un error, favor solicitar la reserva nuevamente'})}
                                    ...
                                    let htmlText = '<div style="background:#F2F2F2"> <div id="div1" style=" background:#000000; text-align:center; max-width: 70%; margin: auto;"> <img style=" margin-top: 50px; width: 12%; margin-left: 72%;" src="https://prismafest.herokuapp.com/images/puchaus-02.png"> <img src="https://prismafest.herokuapp.com/images/felicidades-01.png" style="width:60%;"> <h3 style=" margin: 0px; font-size: 130%; font-family: lato; font-weight: 500; color: white; letter-spacing: 5px;">SOS DE LOS QUE SE ATREVEN</h3> <img style=" width: 12%; margin-right: 72%; margin-bottom: 50px;" src="https://prismafest.herokuapp.com/images/puchaus-01.png"> </div> <div id="div2" style=" background:#FFFFFF; text-align:center; max-width: 70%; margin: auto;">  <div><h2 style="margin: 0px; padding-top: 80px; margin-bottom: 40px; font-size: 145%; font-family: lato; font-weight: bold; color: black; letter-spacing: 5px;">¡ESTÁS CONFIRMADO!</h2></div> <p style="  margin: auto; margin-bottom: 40px; font-size: 18px; font-family: lato; font-weight: 500; color: #424242; width: 90%;">Bienvenido ' + req.body.name+'. Estamos contentos de contar con su presencia en el evento.</p><p style="  margin: auto; padding-bottom: 40px; font-size: 18px; font-family: lato; font-weight: 500; color: #424242; width: 90%;">Le confirmamos la reservación de su espacio en la conferencia <b>'+doc4.value.description+'</b>. Nos vemos el día del evento.</p> </div> <div id="div3" style=" background:#F2F2F2; text-align:center; max-width: 70%; margin: auto;"> <a style="text-decoration: none; margin-left: 98%;" href="https://www.facebook.com/images/prismafest.cr/" target="_blank"><img style=" max-height: 20px; margin-right: 10px; margin-top: 10px; cursor: pointer;" src="https://prismafest.herokuapp.com/images/puchaus-05.png"></a> <br> <img style=" max-height: 100px; margin-bottom: 30px;" src="https://prismafest.herokuapp.com/images/puchaus-06.png"> <br> <div style="height:80px;"> <a style="text-decoration: none; color: #999999; cursor: pointer; font-family: lato; font-size: 20px;" href="https://prismafest.com/" target="_blank">www.prismafest.com</a> </div> </div> </div>',
                                    mailOptions = {
                                      from: '"Prisma Fest" <info@prismafest.com>',
                                      to: req.body.email, // receiver
                                      subject: 'Prisma Fest', // subject
                                    ...
                                    gmailTransporter(function (transporter) {
                                        transporter.sendMail(mailOptions, function(error5, info){
                                          if(error5) {throw error5; res.send(400, {error:'Hemos tenido un error, favor solicitar la reserva nuevamente'})}
                                          else{ 
                                            console.log('Enviando Email');
                                            console.log(info);
                                            res.send(200,{info:'Message Sent'} ); 
